...
export default function UpdatePasswordForm({ className = '' }) {
    ...
    return (
        <section className={className} style={{ marginLeft: "10px", padding: '20px', backgroundColor: 'white', borderRadius: '10px'}}>
            <header>
                <h2 className="text-lg font-medium text-gray-900">Perbarui Password</h2>

                <p className="mt-1 text-sm text-gray-600">
                    Minimal 8 digit atau lebih dengan karakter acak demi keamanan akun Anda.
                </p>
            </header>
